...
![대전 화면](docs/screenshots/battle.png)

| 덱빌더 | 덱 선택 · 대전 모드 |
|---|---|
| ![덱빌더](docs/screenshots/deck-builder.png) | ![덱 선택](docs/screenshots/deck-select.png) |
| 카드 검색·필터, 드래그 앤 드롭 편집, 40장 / 트리거 8장 실시간 검증 | AI 대전 · 온라인 대전(방 코드) · 커스텀 덱 관리 |

| 로그인 (선택) |
|---|
| ![로그인](docs/screenshots/login.png) |
| 로그인하면 덱이 계정에 저장돼 다른 PC에서도 사용할 수 있고, 로그인하지 않아도 그대로 플레이할 수 있습니다 |
